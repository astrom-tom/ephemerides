...
If you want dates after January 2023, you must webscrap the ephemerides from the ESO website. To do so you use the **get_yearly_ephemerides()** function. The help of this function will help you to use it::
...
This function will webscrap all the ephemerides for the next month. The files will be places in the directory ephem inside the module. They have a format 'ESO_ephem_Observatory_name_year_month.txt' and are human readable.
